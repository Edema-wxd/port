  ...
  return (
    <>
      <div className={style.contact} id="contact">
        ...
        <form
          action="https://docs.google.com/forms/d/e/1FAIpQLSdvcBfWWnn-ArjFo4QYXcgbEs4Pi9xswP7R0zad8a68Hmn5Qw/formResponse"
          method="POST"
          className={style.conform}
        >
          <br />
          <input
